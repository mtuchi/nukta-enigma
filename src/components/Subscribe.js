...
class Subscribe extends Component {
  ...
  handleSubmit(event) {
    ...
    if (
      emailPattern.test(subscribeInput) ||
      phonePattern.test(subscribeInput)
    ) {
      ...
      axios
        .post(
          'https://script.google.com/macros/s/AKfycbw4O1zOmc3CbWEO0TdvM7udi9oALACGIenWWnyT7clCcLoC1i4e/exec',
          formData,
          {
            headers: {
  ...
  render() {
    ...
    return (
      <div className="mtb-50 mb-md-0">
        ...
        <p className="mb-20">
          Jiunge nasi uweze kupata habari motomoto zinazokuhusu kwa wakati.
        </p>
        <form className="nwsltr-primary-1" onSubmit={this.handleSubmit}>
          <input
            type="text"
            className="subscriber-email"
            value={value}
            onChange={this.handleChange}
            placeholder="Barua pepe au Simu ya mkononi"
          />
          <button type="submit">
